                ...
                <tr>
                    <td style="padding: 36px 40px;">
                        ...
                        <p style="margin:0 0 16px; font-size:16px; color:#1e293b;">
                            Bonjour <strong><?php echo e($utilisateur->prenom); ?> <?php echo e($utilisateur->nom); ?></strong>,
                        </p>

                        <?php if($organisationNom): ?>
                        <p style="margin:0 0 24px; font-size:15px; color:#475569; line-height:1.6;">
                            Votre compte administrateur pour l'organisation
                            <strong style="color:#2563eb;"><?php echo e($organisationNom); ?></strong>
...
<?php /**PATH E:\CODING\DSTCOMPUTING\Plateforme\SEN_ARCHIVAGE\SenArhive_Sn\resources\views\emails\access_credentials.blade.php ENDPATH**/ ?>