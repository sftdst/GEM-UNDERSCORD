...
<div class="container">
    ...
    <div class="body">
        ...
        <p>Bonjour <strong><?php echo e($utilisateur->prenom); ?> <?php echo e($utilisateur->nom); ?></strong>,</p>
        <p>
            Nous avons le plaisir de vous informer que votre demande d'accès à la période d'essai
            pour l'organisation <strong><?php echo e($organisation->nom); ?></strong> a été approuvée.
        </p>
        <div class="highlight">
        ...
        <p>Connectez-vous dès maintenant avec votre email <strong><?php echo e($utilisateur->email); ?></strong> :</p>
    ...
    <div class="footer">
        © <?php echo e(date('Y')); ?> SenArhive — Plateforme d'archivage électronique
    </div>
</div>
</body>
</html>
<?php /**PATH E:\CODING\DSTCOMPUTING\Plateforme\SEN_ARCHIVAGE\SenArhive_Sn\resources\views\emails\demande_essai_approuvee.blade.php ENDPATH**/ ?>