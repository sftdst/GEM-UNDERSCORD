...
<head>
    ...
    <title><?php echo e($dossier->nom); ?> — SenArhive</title>
...
<body>
    <div class="container">
        ...
        <div class="dossier-header">
            <div class="folder-icon" style="background: <?php echo e($dossier->couleur ?? '#6366f1'); ?>22;">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="<?php echo e($dossier->couleur ?? '#6366f1'); ?>" stroke-width="2"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>
            </div>
            <div>
                <div class="dossier-title"><?php echo e($dossier->nom); ?></div>
                <?php if($dossier->chemin): ?>
                    <div class="dossier-path"><?php echo e($dossier->chemin); ?></div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="tree">
            <?php echo $__env->make('partials.dossier_node', ['node' => $arborescence, 'root' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>

        <div class="footer">
            Généré le <?php echo e(now()->format('d/m/Y à H:i')); ?> &bull; SenArhive — Plateforme de Gestion Électronique de Documents
        </div>
    </div>
</body>
</html>
<?php /**PATH E:\CODING\DSTCOMPUTING\Plateforme\SEN_ARCHIVAGE\SenArhive_Sn\resources\views\dossier_public.blade.php ENDPATH**/ ?>