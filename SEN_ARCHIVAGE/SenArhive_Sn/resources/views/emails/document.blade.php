...
<body>
    <div class="container">
        ...
        <div class="body">
            <p>Bonjour,</p>
            <p><strong>{{ $expediteurNom }}</strong> vous a partagé un document via la plateforme SEN_ARCHIV.</p>
            ...
            <div class="doc-card">
                ...
                <span style="display:block; margin-top:8px;">
                    Extension : {{ strtoupper($document->extension ?? 'N/A') }}
                    &nbsp;|&nbsp;
                    Taille : {{ $document->taille_formatee ?? 'N/A' }}
                </span>
            </div>
        ...
        <div class="footer">
            <p>Cet email a été envoyé via SEN_ARCHIV &mdash; {{ config('app.name') }}</p>
        </div>
    </div>
</body>
</html>
