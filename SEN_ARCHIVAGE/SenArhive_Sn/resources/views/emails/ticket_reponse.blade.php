                ...
                <tr>
                    <td style="padding: 36px 40px;">
                        ...
                        <p style="margin:0 0 16px; font-size:16px; color:#1e293b;">
                            Bonjour <strong>{{ $ticket->utilisateur?->prenom }} {{ $ticket->utilisateur?->nom }}</strong>,
                        </p>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td style="padding: 18px 20px;">
                                    ...
                                    <p style="margin:0; font-size:14px; color:#334155; line-height:1.7; white-space:pre-line;">{{ $reponse }}</p>
                                </td>
                            </tr>
                        </table>
